##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.1.0] date: [Thu Sep 07 15:30:40 CST 2023] 
##########################################################################################################################
...
# C sources
C_SOURCES =  \
Mylibs/RING_FIFO/src/ring_fifo.c \
Mylibs/KEY/src/key.c \
Core/Src/onchip_flash.c \
Core/Src/device.c \
Core/Src/update.c \
Core/Src/tasks.c \
Core/Src/common.c \
